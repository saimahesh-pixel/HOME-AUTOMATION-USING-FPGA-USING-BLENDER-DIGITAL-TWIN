...
REM
REM Generated by Vivado on Tue Jul 07 22:04:49 +0530 2026
...
echo "xvlog --incr --relax -prj ultrasonic_display_top_vlog.prj"
call xvlog  --incr --relax -prj ultrasonic_display_top_vlog.prj -log xvlog.log
