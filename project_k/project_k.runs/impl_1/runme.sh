...
HD_PWD='C:/Users/saima/project_k/project_k.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ultrasonic_display_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ultrasonic_display_top.tcl -notrace
