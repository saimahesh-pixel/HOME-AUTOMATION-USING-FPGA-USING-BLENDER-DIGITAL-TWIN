...
HD_PWD='C:/Users/saima/project_k/project_k.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultrasonic_display_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultrasonic_display_top.tcl
